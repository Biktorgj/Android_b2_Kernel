				 ...
				 struct shrink_control *sc)
{
	...
	ion_page_pool_total_pages = ion_page_pool_total(true);

	pr_info("%s: ion_page_pool_total of HIGHMEM: %d, nr_freed: %d\n",
			__func__, ion_page_pool_total_pages, nr_freed);

	return ion_page_pool_total_pages;
}
