...
_mali_osk_mutex_t *mali_freq_lock = 0;
...
static mali_bool init_mali_clock(void)
{
	...
	mali_freq_lock = _mali_osk_mutex_init( _MALI_OSK_LOCKFLAG_ORDERED, 0);
