...
/*
 * driver/misc/clkmon/clk_mon_exynos3.c
 *
...
static struct clk_gate_mask clk_gate_masks[] = {
	...
	/* CLK_GATE_IP_PERIR */
	{"CLK_MONOCNT", (0x1 << 22),CLK_MON_CGATE_IP_PERIR},
	{"CLK_TZPC6", (0x1 << 21),CLK_MON_CGATE_IP_PERIR},
	{"CLK_PROVISIONKEY1", (0x1 << 20),CLK_MON_CGATE_IP_PERIR},
	{"CLK_PROVISIONKEY0", (0x1 << 19),CLK_MON_CGATE_IP_PERIR},
	...
	{"CLK_TZPC5", (0x1 << 10), CLK_MON_CGATE_IP_PERIL},
	...
	/* CLK_GATE_IP_CAM */
	{"CLK_QEJPEG", (0x1 << 19), CLK_MON_CGATE_IP_CAM},
	...
	{"CLK_QEM2MSCALER", (0x1 << 14), CLK_MON_CGATE_IP_CAM},
	{"CLK_QEGSCALER1",(0X1 << 13), CLK_MON_CGATE_IP_CAM},
	{"CLK_QEGSCALER0", (0x1 << 12), CLK_MON_CGATE_IP_CAM},
	{"CLK_SMMUJPEG", (0x1 << 11), CLK_MON_CGATE_IP_CAM},
	{"CLK_SMMUM2MSCALER", (0x1 << 9), CLK_MON_CGATE_IP_CAM},
	{"CLK_SMMUGSCALER1", (0x1 << 8), CLK_MON_CGATE_IP_CAM},
	{"CLK_SMMUGSCALER0", (0x1 << 7), CLK_MON_CGATE_IP_CAM},
	{"CLK_JPEG", (0x1 << 6), CLK_MON_CGATE_IP_CAM},
	{"CLK_M2MSCALER", (0x1 << 2), CLK_MON_CGATE_IP_CAM},
	{"CLK_GSCALER1", (0x1 << 1), CLK_MON_CGATE_IP_CAM},
	{"CLK_GSCALER0", (0x1), CLK_MON_CGATE_IP_CAM},
	/* CLK_GATE_IP_MFC */
	{"CLK_PPMUMFC_R", (0x1 << 5), CLK_MON_CGATE_IP_MFC},
	{"CLK_PPMUMFC_L", (0x1 << 3), CLK_MON_CGATE_IP_MFC},
	{"CLK_SMMUMFC_L", (0x1 << 1), CLK_MON_CGATE_IP_MFC},
	{"CLK_MFC", (0x1 << 0), CLK_MON_CGATE_IP_MFC},
	/* CLK_GATE_IP_G3D */
	{"CLK_SMMUG3D", (0x1 << 3), CLK_MON_CGATE_IP_G3D},
	{"CLK_QEG3D", (0x1 << 2), CLK_MON_CGATE_IP_G3D},
	{"CLK_PPMUG3D", (0x1 << 1), CLK_MON_CGATE_IP_G3D},
	{"CLK_G3D", (0x1), CLK_MON_CGATE_IP_G3D},
	/* CLK_GATE_IP_LCD */
	{"CLK_QE_CH1_LCD", (0x1 << 7), CLK_MON_CGATE_IP_LCD},
	{"CLK_QE_CH0_LCD", (0x1 << 6), CLK_MON_CGATE_IP_LCD},
	{"CLK_PPMULCD0", (0x1 << 5), CLK_MON_CGATE_IP_LCD},
	{"CLK_SMMUFIMD0", (0x1 << 4), CLK_MON_CGATE_IP_LCD},
	{"CLK_DSIM0", (0x1 << 3), CLK_MON_CGATE_IP_LCD},
	{"CLK_FIMD0", (0x1), CLK_MON_CGATE_IP_LCD},
	/* CLK_GATE_IP_ISP */
	{"CLK_CAM1", (0x1 << 5), CLK_MON_CGATE_IP_ISP},
	{"CLK_UART_ISP", (0x1 << 3), CLK_MON_CGATE_IP_ISP},
	{"CLK_SPI1_ISP", (0x1 << 2), CLK_MON_CGATE_IP_ISP},
	{"CLK_SPI0_ISP", (0x1 << 1), CLK_MON_CGATE_IP_ISP},
	/* CLK_GATE_IP_FSYS */
	{"CLK_TSADC", (0x1 << 20), CLK_MON_CGATE_IP_FSYS},
	{"CLK_PPMUFILE", (0x1 << 17), CLK_MON_CGATE_IP_FSYS},
	{"CLK_USBOTG", (0x1 << 13), CLK_MON_CGATE_IP_FSYS},
	...
	{"CLK_PCM", (0x1 << 23), CLK_MON_CGATE_IP_PERIL},
	{"CLK_I2S", (0x1 << 21), CLK_MON_CGATE_IP_PERIL},
	...
	/* CLK_GATE_IP_DMC */
	{"CLK_QEGDL", (0x1 << 28), CLK_MON_CGATE_IP_DMC0},
	{"CLK_ASYNC_GDL", (0x1 << 21), CLK_MON_CGATE_IP_DMC0},
	{"CLK_PPMUDMC0", (0x1 << 8), CLK_MON_CGATE_IP_DMC0},
	{"CLK_FBMDMC0", (0x1 << 5), CLK_MON_CGATE_IP_DMC0},
	{"CLK_DREX", (0x1), CLK_MON_CGATE_IP_DMC0},
	/* CLK_GATE_IP_CPU */
...
int clk_mon_clock_gate(unsigned int *clk_status)
{
	...
	for (i = 0; clk_gate_masks[i].addr != NULL; i++) {
		...
		if (val)
			...
			clk_status[idx] |=(0x0 << bit_shift);
	}

	return i;
}

int clk_mon_get_clock_info(unsigned int power_domain_status, unsigned int *clk_status, char *buf)
{
	void *addr = NULL;
	int bit_max = NR_BIT * CLK_GATES_NUM;
	int i=0, val=0;
	...
	size += clk_mon_get_power_info(&power_domain_status, buf);
