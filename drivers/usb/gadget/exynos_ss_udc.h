...
#define EXYNOS_USB3_DEVT_EvtInfo_U0			(0x0 << 16)
#define EXYNOS_USB3_DEVT_EvtInfo_U1			(0x1 << 16)
#define EXYNOS_USB3_DEVT_EvtInfo_U2			(0x2 << 16)
#define EXYNOS_USB3_DEVT_EvtInfo_U3			(0x3 << 16)
#define EXYNOS_USB3_DEVT_EvtInfo_SS_DIS			(0x4 << 16)
#define EXYNOS_USB3_DEVT_EvtInfo_RX_DET			(0x5 << 16)
#define EXYNOS_USB3_DEVT_EvtInfo_Resume_Rst 		(0xf << 16)
