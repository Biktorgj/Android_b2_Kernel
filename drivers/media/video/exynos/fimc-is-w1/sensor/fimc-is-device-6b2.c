...
static struct fimc_is_sensor_cfg config_6b2[] = {
	...
	/* 1924x1082@30fps */
	FIMC_IS_SENSOR_CFG(1924,1082, 30, 16, 0),
	/* 1936x1090@24fps */
	FIMC_IS_SENSOR_CFG(1924,1082, 24, 16, 0),
	/* 1924x1082@15fps */
	FIMC_IS_SENSOR_CFG(1924,1082, 15, 16, 0),
#else
	/* 1936x1090@30fps */
	...
	const struct i2c_device_id *id)
{
...
#if defined(CONFIG_SOC_EXYNOS3250)
	module->pixel_width = module->active_width + 4;
	module->pixel_height = module->active_height + 2;
#else
	...
	ext->sensor_con.peri_setting.i2c.slave_address = 0x6A;
