...
static struct s5p_mfc_ctrl_cfg mfc_ctrl_list[] = {
	...
	{	/* H.264 QP Max change */
		...
		.flag_mode = MFC_CTRL_MODE_CUSTOM,
		.flag_addr = S5P_FIMV_PARAM_CHANGE_FLAG,
		.flag_shft = S5P_FIMV_PARAM_CHANGE_FLAG_SHIFT,
	},
	{	/* H.264 QP Min change */
		.type = MFC_CTRL_TYPE_SET,
		.id = V4L2_CID_MPEG_VIDEO_H264_MIN_QP,
...
static int set_enc_param(struct s5p_mfc_ctx *ctx, struct v4l2_control *ctrl)
{
	...
	case V4L2_CID_MPEG_VIDEO_H264_LEVEL:
		p->codec.h264.level =
			h264_level((enum v4l2_mpeg_video_h264_level)
			(ctrl->value));
		break;
	...
	case V4L2_CID_MPEG_VIDEO_H264_VUI_SAR_IDC:
		p->codec.h264.ar_vui_idc =
			vui_sar_idc((enum v4l2_mpeg_video_h264_vui_sar_idc)
			(ctrl->value));
		break;
	...
	case V4L2_CID_MPEG_VIDEO_H264_SEI_FP_ARRANGEMENT_TYPE:
		p->codec.h264.sei_fp_arrangement_type =
	...
	case V4L2_CID_MPEG_VIDEO_MPEG4_LEVEL:
		p->codec.mpeg4.level =
			mpeg4_level((enum v4l2_mpeg_video_mpeg4_level)
			(ctrl->value));
		break;
