...
/* SR130PC20 default format (codes, sizes, preset values) */
...
static const struct sr130pc20_resolution sr130pc20_resolutions[] = {
	...
	{CAPTURE_SZ_VGA		, SR130PC20_OPRMODE_IMAGE, 640,  480  },
...
#define TUNING_FILE_PATH "/data/media/0/sr130pc20_regs.h"
#endif /* CONFIG_LOAD_FILE*/
#if defined(CONFIG_MACH_DELOSLTE_KOR_SKT) || defined(CONFIG_MACH_DELOSLTE_KOR_LGT)
#include "sr130pc20_regs_delos_kor.h"
#else
