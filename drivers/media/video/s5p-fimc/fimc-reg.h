...
#define FIMC_REG_CIOCTRL_2P_OUT_ORDER_LSB_CBCR	(0 << 24)
#define FIMC_REG_CIOCTRL_2P_OUT_ORDER_LSB_CRCB	(1 << 24)
...
#define FIMC_REG_MSCTRL_2P_IN_ORDER_LSB_CBCR	(0 << 16)
#define FIMC_REG_MSCTRL_2P_IN_ORDER_LSB_CRCB	(1 << 16)
...
#define SYSREG_CAMERA_BLK			(S5P_VA_SYS + 0x0218)
#define SYSREG_ISP_BLK				(S5P_VA_SYS + 0x020c)
