...
u32 __cpu_mpidr_map[NR_CPUS] = { [0 ... NR_CPUS-1] = MPIDR_INVALID };
...
//  lcdtype=0 oops=panic pmic_info=1875  sysscope=0xee000000  cordon=224b9a60bc1c844275150b8275305f0b
	...
	char console_settings[]="console=ram loglevel=4 no_console_suspend androidboot.selinux=disabled ";
...
/* Defs end */
	...
	else // If you can't, act like you did
		{
