...
/* EXYNOS3 GPIO bank sizes */

#define EXYNOS3_GPIO_A0_NR      (8)
#define EXYNOS3_GPIO_A1_NR      (6)
#define EXYNOS3_GPIO_B_NR       (8)
#define EXYNOS3_GPIO_C0_NR      (5)
#define EXYNOS3_GPIO_C1_NR      (5)
#define EXYNOS3_GPIO_D0_NR      (4)
#define EXYNOS3_GPIO_D1_NR      (4)
#define EXYNOS3_GPIO_E0_NR      (8)
#define EXYNOS3_GPIO_E1_NR      (8)
#define EXYNOS3_GPIO_E2_NR      (3)

#define EXYNOS3_GPIO_K0_NR      (8)
#define EXYNOS3_GPIO_K1_NR      (7)
#define EXYNOS3_GPIO_K2_NR      (7)
#define EXYNOS3_GPIO_L0_NR      (4)
#define EXYNOS3_GPIO_X0_NR      (8)
#define EXYNOS3_GPIO_X1_NR      (8)
#define EXYNOS3_GPIO_X2_NR      (8)
#define EXYNOS3_GPIO_X3_NR      (8)

/*ETC0,ETC6 not add then*/

#define EXYNOS3_GPIO_M0_NR      (8)
#define EXYNOS3_GPIO_M1_NR      (7)
#define EXYNOS3_GPIO_M2_NR      (5)
#define EXYNOS3_GPIO_M3_NR      (8)
#define EXYNOS3_GPIO_M4_NR      (8)

/* EXYNOS3 GPIO bank numbers */

enum exynos3_gpio_number {
	EXYNOS3_GPIO_A0_START   = 0,
	EXYNOS3_GPIO_A1_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_A0),
	EXYNOS3_GPIO_B_START    = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_A1),
	EXYNOS3_GPIO_C0_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_B),
	EXYNOS3_GPIO_C1_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_C0),
	EXYNOS3_GPIO_D0_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_C1),
	EXYNOS3_GPIO_D1_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_D0),
	EXYNOS3_GPIO_E0_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_D1),
	EXYNOS3_GPIO_E1_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_E0),
	EXYNOS3_GPIO_E2_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_E1),
	EXYNOS3_GPIO_K0_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_E2),
	EXYNOS3_GPIO_K1_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_K0),
	EXYNOS3_GPIO_K2_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_K1),
	EXYNOS3_GPIO_L0_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_K2),
	EXYNOS3_GPIO_X0_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_L0),
	EXYNOS3_GPIO_X1_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_X0),
	EXYNOS3_GPIO_X2_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_X1),
	EXYNOS3_GPIO_X3_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_X2),
	EXYNOS3_GPIO_M0_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_X3),
	EXYNOS3_GPIO_M1_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_M0),
	EXYNOS3_GPIO_M2_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_M1),
	EXYNOS3_GPIO_M3_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_M2),
	EXYNOS3_GPIO_M4_START   = EXYNOS_GPIO_NEXT(EXYNOS3_GPIO_M3),
};

/* EXYNOS3 GPIO number definitions */

#define EXYNOS3_GPA0(_nr)       (EXYNOS3_GPIO_A0_START + (_nr))
#define EXYNOS3_GPA1(_nr)       (EXYNOS3_GPIO_A1_START + (_nr))
#define EXYNOS3_GPB(_nr)        (EXYNOS3_GPIO_B_START + (_nr))
#define EXYNOS3_GPC0(_nr)       (EXYNOS3_GPIO_C0_START + (_nr))
#define EXYNOS3_GPC1(_nr)       (EXYNOS3_GPIO_C1_START + (_nr))
#define EXYNOS3_GPD0(_nr)       (EXYNOS3_GPIO_D0_START + (_nr))
#define EXYNOS3_GPD1(_nr)       (EXYNOS3_GPIO_D1_START + (_nr))
#define EXYNOS3_GPE0(_nr)       (EXYNOS3_GPIO_E0_START + (_nr))
#define EXYNOS3_GPE1(_nr)       (EXYNOS3_GPIO_E1_START + (_nr))
#define EXYNOS3_GPE2(_nr)       (EXYNOS3_GPIO_E2_START + (_nr))
#define EXYNOS3_GPK0(_nr)       (EXYNOS3_GPIO_K0_START + (_nr))
#define EXYNOS3_GPK1(_nr)       (EXYNOS3_GPIO_K1_START + (_nr))
#define EXYNOS3_GPK2(_nr)       (EXYNOS3_GPIO_K2_START + (_nr))
#define EXYNOS3_GPL0(_nr)       (EXYNOS3_GPIO_L0_START + (_nr))
#define EXYNOS3_GPX0(_nr)       (EXYNOS3_GPIO_X0_START + (_nr))
#define EXYNOS3_GPX1(_nr)       (EXYNOS3_GPIO_X1_START + (_nr))
#define EXYNOS3_GPX2(_nr)       (EXYNOS3_GPIO_X2_START + (_nr))
#define EXYNOS3_GPX3(_nr)       (EXYNOS3_GPIO_X3_START + (_nr))
#define EXYNOS3_GPM0(_nr)       (EXYNOS3_GPIO_M0_START + (_nr))
#define EXYNOS3_GPM1(_nr)       (EXYNOS3_GPIO_M1_START + (_nr))
#define EXYNOS3_GPM2(_nr)       (EXYNOS3_GPIO_M2_START + (_nr))
#define EXYNOS3_GPM3(_nr)       (EXYNOS3_GPIO_M3_START + (_nr))
#define EXYNOS3_GPM4(_nr)       (EXYNOS3_GPIO_M4_START + (_nr))

/* the end of the EXYNOS3 specific gpios */

#define EXYNOS3_GPIO_END        (EXYNOS3_GPM4(7) + 1)
#define SAMSUNG_GPIO_END                (EXYNOS3_GPIO_END)
...
#define EXYNOS4_GPIO_MP0_0_NR	(6)
#define EXYNOS4_GPIO_MP0_1_NR	(4)
#define EXYNOS4_GPIO_MP0_2_NR	(6) /*size not mentioned in the manual */
#define EXYNOS4_GPIO_MP0_3_NR	(8)
#define EXYNOS4_GPIO_MP0_4_NR	(8)
#define EXYNOS4_GPIO_MP0_5_NR	(8)
#define EXYNOS4_GPIO_MP0_6_NR	(8)
...
enum exynos4_gpio_number {
	...
	EXYNOS4_GPIO_F0_START   = EXYNOS_GPIO_NEXT(EXYNOS4_GPIO_D1),
	EXYNOS4_GPIO_F1_START	= EXYNOS_GPIO_NEXT(EXYNOS4_GPIO_F0),
	EXYNOS4_GPIO_F2_START	= EXYNOS_GPIO_NEXT(EXYNOS4_GPIO_F1),
	EXYNOS4_GPIO_K0_START   = EXYNOS_GPIO_NEXT(EXYNOS4_GPIO_F2),
	...
	EXYNOS4_GPIO_MP0_0_START = EXYNOS_GPIO_NEXT(EXYNOS4_GPIO_L0),
	EXYNOS4_GPIO_MP0_1_START = EXYNOS_GPIO_NEXT(EXYNOS4_GPIO_MP0_0),
	EXYNOS4_GPIO_MP0_2_START = EXYNOS_GPIO_NEXT(EXYNOS4_GPIO_MP0_1),
	EXYNOS4_GPIO_MP0_3_START = EXYNOS_GPIO_NEXT(EXYNOS4_GPIO_MP0_2),
	EXYNOS4_GPIO_MP0_4_START = EXYNOS_GPIO_NEXT(EXYNOS4_GPIO_MP0_3),
	EXYNOS4_GPIO_MP0_5_START = EXYNOS_GPIO_NEXT(EXYNOS4_GPIO_MP0_4),
	EXYNOS4_GPIO_MP0_6_START = EXYNOS_GPIO_NEXT(EXYNOS4_GPIO_MP0_5),
	EXYNOS4_GPIO_M0_START	= EXYNOS_GPIO_NEXT(EXYNOS4_GPIO_MP0_6),
...
#ifdef CONFIG_SOC_EXYNOS4415
#define EXYNOS4_GPY0(_nr)       (EXYNOS4_GPIO_MP0_0_START + (_nr))
#define EXYNOS4_GPY1(_nr)       (EXYNOS4_GPIO_MP0_1_START + (_nr))
#define EXYNOS4_GPY2(_nr)       (EXYNOS4_GPIO_MP0_2_START + (_nr))
#define EXYNOS4_GPY3(_nr)       (EXYNOS4_GPIO_MP0_3_START + (_nr))
#define EXYNOS4_GPY4(_nr)       (EXYNOS4_GPIO_MP0_4_START + (_nr))
#define EXYNOS4_GPY5(_nr)       (EXYNOS4_GPIO_MP0_5_START + (_nr))
#define EXYNOS4_GPY6(_nr)       (EXYNOS4_GPIO_MP0_6_START + (_nr))
#else
...
/* EXYNOS5260 GPIO bank sizes */

#define EXYNOS5260_GPIO_A0_NR	(4)
#define EXYNOS5260_GPIO_A1_NR	(7)
#define EXYNOS5260_GPIO_A2_NR	(8)
#define EXYNOS5260_GPIO_B0_NR	(5)
#define EXYNOS5260_GPIO_B1_NR	(4)
#define EXYNOS5260_GPIO_B2_NR	(4)
#define EXYNOS5260_GPIO_B3_NR	(8)
#define EXYNOS5260_GPIO_B4_NR	(8)
#define EXYNOS5260_GPIO_B5_NR	(8)
#define EXYNOS5260_GPIO_D0_NR	(8)
#define EXYNOS5260_GPIO_D1_NR	(7)
#define EXYNOS5260_GPIO_D2_NR	(5)
#define EXYNOS5260_GPIO_E0_NR	(8)
#define EXYNOS5260_GPIO_E1_NR	(5)
#define EXYNOS5260_GPIO_F0_NR	(4)
#define EXYNOS5260_GPIO_F1_NR	(8)
#define EXYNOS5260_GPIO_K0_NR	(2)
#define EXYNOS5260_GPIO_X0_NR	(8)
#define EXYNOS5260_GPIO_X1_NR	(8)
#define EXYNOS5260_GPIO_X2_NR	(8)
#define EXYNOS5260_GPIO_X3_NR	(8)
#define EXYNOS5260_GPIO_C0_NR	(7)
#define EXYNOS5260_GPIO_C1_NR	(6)
#define EXYNOS5260_GPIO_C2_NR	(7)
#define EXYNOS5260_GPIO_C3_NR	(4)
#define EXYNOS5260_GPIO_C4_NR	(4)
#define EXYNOS5260_GPIO_Z0_NR	(7)
#define EXYNOS5260_GPIO_Z1_NR	(4)

enum exynos5260_gpio_number {
	EXYNOS5260_GPIO_A0_START	= 0,
	EXYNOS5260_GPIO_A1_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_A0),
	EXYNOS5260_GPIO_A2_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_A1),
	EXYNOS5260_GPIO_B0_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_A2),
	EXYNOS5260_GPIO_B1_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_B0),
	EXYNOS5260_GPIO_B2_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_B1),
	EXYNOS5260_GPIO_B3_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_B2),
	EXYNOS5260_GPIO_B4_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_B3),
	EXYNOS5260_GPIO_B5_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_B4),
	EXYNOS5260_GPIO_D0_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_B5),
	EXYNOS5260_GPIO_D1_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_D0),
	EXYNOS5260_GPIO_D2_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_D1),
	EXYNOS5260_GPIO_E0_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_D2),
	EXYNOS5260_GPIO_E1_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_E0),
	EXYNOS5260_GPIO_F0_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_E1),
	EXYNOS5260_GPIO_F1_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_F0),
	EXYNOS5260_GPIO_K0_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_F1),
	EXYNOS5260_GPIO_X0_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_K0),
	EXYNOS5260_GPIO_X1_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_X0),
	EXYNOS5260_GPIO_X2_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_X1),
	EXYNOS5260_GPIO_X3_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_X2),
	EXYNOS5260_GPIO_C0_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_X3),
	EXYNOS5260_GPIO_C1_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_C0),
	EXYNOS5260_GPIO_C2_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_C1),
	EXYNOS5260_GPIO_C3_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_C2),
	EXYNOS5260_GPIO_C4_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_C3),
	EXYNOS5260_GPIO_Z0_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_C4),
	EXYNOS5260_GPIO_Z1_START	= EXYNOS_GPIO_NEXT(EXYNOS5260_GPIO_Z0),
};

/* EXYNOS5260 GPIO number definitions */

#define EXYNOS5260_GPA0(_nr)	(EXYNOS5260_GPIO_A0_START + (_nr))
#define EXYNOS5260_GPA1(_nr)	(EXYNOS5260_GPIO_A1_START + (_nr))
#define EXYNOS5260_GPA2(_nr)	(EXYNOS5260_GPIO_A2_START + (_nr))
#define EXYNOS5260_GPB0(_nr)	(EXYNOS5260_GPIO_B0_START + (_nr))
#define EXYNOS5260_GPB1(_nr)	(EXYNOS5260_GPIO_B1_START + (_nr))
#define EXYNOS5260_GPB2(_nr)	(EXYNOS5260_GPIO_B2_START + (_nr))
#define EXYNOS5260_GPB3(_nr)	(EXYNOS5260_GPIO_B3_START + (_nr))
#define EXYNOS5260_GPB4(_nr)	(EXYNOS5260_GPIO_B4_START + (_nr))
#define EXYNOS5260_GPB5(_nr)	(EXYNOS5260_GPIO_B5_START + (_nr))
#define EXYNOS5260_GPD0(_nr)	(EXYNOS5260_GPIO_D0_START + (_nr))
#define EXYNOS5260_GPD1(_nr)	(EXYNOS5260_GPIO_D1_START + (_nr))
#define EXYNOS5260_GPD2(_nr)	(EXYNOS5260_GPIO_D2_START + (_nr))
#define EXYNOS5260_GPE0(_nr)	(EXYNOS5260_GPIO_E0_START + (_nr))
#define EXYNOS5260_GPE1(_nr)	(EXYNOS5260_GPIO_E1_START + (_nr))
#define EXYNOS5260_GPF0(_nr)	(EXYNOS5260_GPIO_F0_START + (_nr))
#define EXYNOS5260_GPF1(_nr)	(EXYNOS5260_GPIO_F1_START + (_nr))
#define EXYNOS5260_GPK0(_nr)	(EXYNOS5260_GPIO_K0_START + (_nr))
#define EXYNOS5260_GPX0(_nr)	(EXYNOS5260_GPIO_X0_START + (_nr))
#define EXYNOS5260_GPX1(_nr)	(EXYNOS5260_GPIO_X1_START + (_nr))
#define EXYNOS5260_GPX2(_nr)	(EXYNOS5260_GPIO_X2_START + (_nr))
#define EXYNOS5260_GPX3(_nr)	(EXYNOS5260_GPIO_X3_START + (_nr))
#define EXYNOS5260_GPC0(_nr)	(EXYNOS5260_GPIO_C0_START + (_nr))
#define EXYNOS5260_GPC1(_nr)	(EXYNOS5260_GPIO_C1_START + (_nr))
#define EXYNOS5260_GPC2(_nr)	(EXYNOS5260_GPIO_C2_START + (_nr))
#define EXYNOS5260_GPC3(_nr)	(EXYNOS5260_GPIO_C3_START + (_nr))
#define EXYNOS5260_GPC4(_nr)	(EXYNOS5260_GPIO_C4_START + (_nr))
#define EXYNOS5260_GPZ0(_nr)	(EXYNOS5260_GPIO_Z0_START + (_nr))
#define EXYNOS5260_GPZ1(_nr)	(EXYNOS5260_GPIO_Z1_START + (_nr))

/* the end of the EXYNOS5260 specific gpios */
#define EXYNOS5260_GPIO_END	(EXYNOS5260_GPZ1(EXYNOS5260_GPIO_Z1_NR) + 1)
...
#define S3C_GPIO_END		(EXYNOS3_GPIO_END)
...
#define S3C_GPIO_END		(EXYNOS5260_GPIO_END)
#else
...
static inline int irq_to_gpio(unsigned int irq)
{
	if (soc_is_exynos5250()) {
		...
		switch (irq) {
		case IRQ_EINT(0) ... IRQ_EINT(7):
			return EXYNOS5260_GPX0(0) + irq - IRQ_EINT(0);
		case IRQ_EINT(8) ... IRQ_EINT(15):
			return EXYNOS5260_GPX1(0) + irq - IRQ_EINT(8);
		case IRQ_EINT(16) ... IRQ_EINT(23):
			return EXYNOS5260_GPX2(0) + irq - IRQ_EINT(16);
		case IRQ_EINT(24) ... IRQ_EINT(31):
			return EXYNOS5260_GPX3(0) + irq - IRQ_EINT(24);
		}
		...
		switch (irq) {
		case IRQ_EINT(0) ... IRQ_EINT(7):
			return EXYNOS3_GPX0(0) + irq - IRQ_EINT(0);
		case IRQ_EINT(8) ... IRQ_EINT(15):
			return EXYNOS3_GPX1(0) + irq - IRQ_EINT(8);
		case IRQ_EINT(16) ... IRQ_EINT(23):
			return EXYNOS3_GPX2(0) + irq - IRQ_EINT(16);
		case IRQ_EINT(24) ... IRQ_EINT(31):
			return EXYNOS3_GPX3(0) + irq - IRQ_EINT(24);
		}
	} else {
		switch (irq) {
		case IRQ_EINT(0) ... IRQ_EINT(7):
...
extern void exynos_eint_fltcon_config(int en, int sel, int width);
