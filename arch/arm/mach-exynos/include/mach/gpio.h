...
/* GPIO_Y serise share with EXYNOS4415 and EXYNOS3470 */
#define EXYNOS4_GPIO_Y0_NR	(6)	/* EXYNOS4_GPIO_MP0_0_NR */
#define EXYNOS4_GPIO_Y1_NR	(4)	/* EXYNOS4_GPIO_MP0_1_NR */
#define EXYNOS4_GPIO_Y2_NR	(6)	/* EXYNOS4_GPIO_MP0_2_NR */
#define EXYNOS4_GPIO_Y3_NR	(8)	/* EXYNOS4_GPIO_MP0_3_NR */
#define EXYNOS4_GPIO_Y4_NR	(8)	/* EXYNOS4_GPIO_MP0_4_NR */
#define EXYNOS4_GPIO_Y5_NR	(8)	/* EXYNOS4_GPIO_MP0_5_NR */
#define EXYNOS4_GPIO_Y6_NR	(8)	/* EXYNOS4_GPIO_MP0_6_NR */
...
enum exynos4_gpio_number {
	...
	EXYNOS4_GPIO_K0_START	= EXYNOS_GPIO_NEXT(EXYNOS4_GPIO_F3),
#else
	EXYNOS4_GPIO_F3_START	= EXYNOS_GPIO_NEXT(EXYNOS4_GPIO_F2),
...
#if defined(CONFIG_SOC_EXYNOS4415) || defined(CONFIG_SOC_EXYNOS3470)
	EXYNOS4_GPIO_Y0_START	= EXYNOS_GPIO_NEXT(EXYNOS4_GPIO_L0),
#else
