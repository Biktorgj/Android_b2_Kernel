...
extern unsigned int exynos_set_ema(unsigned int target_volt);
...
extern int exynos4415_init_asv(struct asv_common *asv_info);
extern int exynos5260_init_asv(struct asv_common *asv_info);
