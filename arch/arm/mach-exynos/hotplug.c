...
{
#if !defined(CONFIG_SOC_EXYNOS5260) && !defined(CONFIG_SOC_EXYNOS5420)
	unsigned int v, u;
...
void platform_cpu_die(unsigned int cpu)
{
	 ...
	 */
	if (soc_is_exynos5250() || soc_is_exynos5410() || soc_is_exynos5420() || soc_is_exynos5260() || soc_is_exynos3470() || soc_is_exynos3250())
