#ifndef __GPIO_REV_EMUL__
#define __GPIO_REV_EMUL__

#define AP_PD_GPIO_COUNT_REV_EMUL 121
#define AP_INIT_GPIO_COUNT_REV_EMUL 10
#define INTERRUPT_SLEEP_GPIO_COUNT_REV_EMUL 13
#define INTERRUPT_INIT_GPIO_COUNT_REV_EMUL 8

 unsigned int init_gpio_table_rev_emul[AP_INIT_GPIO_COUNT_REV_EMUL][3] =
{
...
unsigned int init_gpio_table_alive_rev_emul[INTERRUPT_INIT_GPIO_COUNT_REV_EMUL][3]=
{
...
unsigned int sleep_gpio_table_alive_rev_emul[INTERRUPT_SLEEP_GPIO_COUNT_REV_EMUL][3] =
{
...
unsigned int sleep_gpio_table_pd_EMUL[AP_PD_GPIO_COUNT_REV_EMUL][3] =
{
	...
	{ EXYNOS3_GPA1(2), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_UPDOWN_DISABLE },	/* AF_SDA  */
	{ EXYNOS3_GPA1(3), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_UPDOWN_DISABLE },	/* AF_SCL  */
	{ EXYNOS3_GPA1(4), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },	/* NC */
	{ EXYNOS3_GPA1(5), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },	/* NC */

	{ EXYNOS3_GPB(0), S3C_GPIO_SFN(0x2), S5P_GPIO_PD_DOWN_ENABLE },		/* SHUB_SPI_SCK */
	{ EXYNOS3_GPB(1), S3C_GPIO_SFN(0x2), S5P_GPIO_PD_DOWN_ENABLE },		/* SHUB_SPI_SSN */
	{ EXYNOS3_GPB(2), S3C_GPIO_SFN(0x2), S5P_GPIO_PD_DOWN_ENABLE },		/* SHUB_SPI_MISO */
	{ EXYNOS3_GPB(3), S3C_GPIO_SFN(0x2), S5P_GPIO_PD_DOWN_ENABLE },		/* SHUB_SPI_MOSI */
	{ EXYNOS3_GPB(4), S3C_GPIO_SFN(0x2), S5P_GPIO_PD_DOWN_ENABLE },	/* CODEC_SPI_SCK */
	...
	{ EXYNOS3_GPD1(0), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },     		/* AP_PMIC_SDA */
	{ EXYNOS3_GPD1(1), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },     		/* AP_PMIC_SCL */
	...
	{ EXYNOS3_GPE0(7), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },        			/* HRM_GLED_EN_AP */
	...
	{ EXYNOS3_GPK0(1), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },  			/* NAND_CMD */
	{ EXYNOS3_GPK0(2), S5P_GPIO_PD_OUTPUT0, S5P_GPIO_PD_UPDOWN_DISABLE },        	/* eMMC_EN */
	{ EXYNOS3_GPK0(3), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE }, 				/* NAND_D0 */
	{ EXYNOS3_GPK0(4), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },  			/* NAND_D1 */
	{ EXYNOS3_GPK0(5), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE }, 				/* NAND_D2 */
	{ EXYNOS3_GPK0(6), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE }, 				/* NAND_D3 */
	{ EXYNOS3_GPK0(7), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE }, 				/* 10K PD */

	{ EXYNOS3_GPK1(0), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_UPDOWN_DISABLE },   			/* WLAN_SD_CLK */
	...
	{ EXYNOS3_GPL0(0), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },  			/* NAND_D4 */
	{ EXYNOS3_GPL0(1), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },  			/* NAND_D5 */
	{ EXYNOS3_GPL0(2), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },  			/* NAND_D6 */
	{ EXYNOS3_GPL0(3), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },  			/* NAND_D7 */
	...
	{ EXYNOS3_GPM2(2), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },        			/* CAM_MCLK */
	{ EXYNOS3_GPM2(3), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },       			/* CAM_nRST */
	...
	{ EXYNOS3_GPM4(0), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },     			/* CAM_SCL */
	{ EXYNOS3_GPM4(1), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },    			/* CAM_SDA */
