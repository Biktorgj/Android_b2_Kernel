...
void __init exynos5_hs_i2c0_set_platdata(struct exynos5_platform_i2c *pd)
{
	...
	if (soc_is_exynos5410()) {
		...
		exynos5_device_hs_i2c0.resource[0].start = EXYNOS5260_PA_HSIIC(0);
		exynos5_device_hs_i2c0.resource[0].end = EXYNOS5260_PA_HSIIC(0) + SZ_4K - 1;
		exynos5_device_hs_i2c0.resource[1].start = IRQ_IIC;
		exynos5_device_hs_i2c0.resource[1].end = IRQ_IIC;
	}
}
