#ifndef __GPIO_REV01__
#define __GPIO_REV01__

#define AP_PD_GPIO_COUNT_REV01 121
#define AP_INIT_GPIO_COUNT_REV01 19
#define INTERRUPT_SLEEP_GPIO_COUNT_REV01 14
#define INTERRUPT_INIT_GPIO_COUNT_REV01 9

 unsigned int init_gpio_table_rev01[AP_INIT_GPIO_COUNT_REV01][3] =
{
...
unsigned int init_gpio_table_alive_rev01[INTERRUPT_INIT_GPIO_COUNT_REV01][3]=
{
...
unsigned int sleep_gpio_table_alive_rev01[INTERRUPT_SLEEP_GPIO_COUNT_REV01][3] =
{
 ...
 unsigned int sleep_gpio_table_pd_rev01[AP_PD_GPIO_COUNT_REV01][3] =
{
