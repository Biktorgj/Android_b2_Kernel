...
#ifndef __MACH_EXYNOS_BOARD_DEGAS_WLAN_H
#define __MACH_EXYNOS_BOARD_DEGAS_WLAN_H

#define GPIO_WLAN_HOST_WAKE EXYNOS4_GPX0(0)

#define GPIO_WLAN_EN 	EXYNOS4_GPF2(4)
...
#endif /* __MACH_EXYNOS_BOARD_DEGAS_WLAN_H */
