...
#define HDMI_LS(_nr) EXYNOS4_GPK3(_nr)
#endif
...
#define HDMI_GPX(_nr) EXYNOS5260_GPX3(_nr)
#define HDMI_LS(_nr) EXYNOS5260_GPD1(_nr)
#endif
#endif
...
void exynos_hdmi_hpd_level_shifter_en(void)
{
#ifdef CONFIG_SOC_EXYNOS4415
	s3c_gpio_cfgpin(HDMI_LS(1), S3C_GPIO_SFN(0x1));
	s3c_gpio_setpull(HDMI_LS(1), S3C_GPIO_PULL_UP);
	gpio_set_value(HDMI_LS(1), 1);

	s3c_gpio_cfgpin(HDMI_LS(2), S3C_GPIO_SFN(0x1));
	s3c_gpio_setpull(HDMI_LS(2), S3C_GPIO_PULL_UP);
	gpio_set_value(HDMI_LS(2), 1);
#endif
#ifdef CONFIG_SOC_EXYNOS5260
	s3c_gpio_cfgpin(HDMI_LS(4), S3C_GPIO_SFN(0x1));
	s3c_gpio_setpull(HDMI_LS(4), S3C_GPIO_PULL_UP);
	gpio_set_value(HDMI_LS(4), 1);

	s3c_gpio_cfgpin(HDMI_LS(5), S3C_GPIO_SFN(0x1));
	s3c_gpio_setpull(HDMI_LS(5), S3C_GPIO_PULL_UP);
	gpio_set_value(HDMI_LS(5), 1);

	s5p_gpio_set_drvstr(EXYNOS5260_GPB3(4), S5P_GPIO_DRVSTR_LV4);
	s5p_gpio_set_drvstr(EXYNOS5260_GPB3(5), S5P_GPIO_DRVSTR_LV4);
#endif
}
