...
#define is_ip_ver_4h	(pdata->ip_ver == IP_VER_TV_4H)
...
#define is_ip_ver_5s	(pdata->ip_ver == IP_VER_TV_5S_0)
#define is_ip_ver_5r	(pdata->ip_ver == IP_VER_TV_5R)
#define is_ip_ver_5g	(is_ip_ver_5g_1)
#define is_ip_ver_5a	(is_ip_ver_5a_0 || is_ip_ver_5a_1)
#define is_ip_ver_5	(is_ip_ver_5g || is_ip_ver_5a || is_ip_ver_5s || is_ip_ver_5r)
#define is_ip_ver_4	(is_ip_ver_4h)
...
extern void exynos_hdmi_hpd_level_shifter_en(void);
#endif
