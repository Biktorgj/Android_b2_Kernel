...
#include "i2s-regs.h"
#include "srp-type.h"
#if defined(CONFIG_SND_SAMSUNG_LPASS)
#include "lpass.h"
#elif defined(CONFIG_SND_SAMSUNG_AUDSS)
#include "audss.h"
#else
static void audss_enable(void) {}
static void audss_disable(void) {}
static struct clk *audss_get_i2s_opclk(int clk_id) { return NULL; };
#endif
